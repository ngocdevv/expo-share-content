...
- `releaseSharedFilesAsync` deletes acknowledged receipt directories immediately.
- Acknowledged but unreleased files become eligible for lazy cleanup seven days after receipt.
